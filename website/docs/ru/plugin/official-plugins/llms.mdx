...
Если вы хотите, чтобы пользователи вашего сайта могли удобнее использовать большие языковые модели для чтения документации, вы можете добавить кнопку «Скопировать Markdown» в шапку страницы через [кастомизацию темы](/guide/basic/custom-theme). Эффект будет таким же, как на этом сайте.
