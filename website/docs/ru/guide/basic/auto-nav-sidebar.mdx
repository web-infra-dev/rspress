...
В Rspress, помимо объявления [nav](/api/config/config-theme.html#nav) и [sidebar](/api/config/config-theme.html#sidebar) в файле конфигурации, вы также можете автоматически генерировать панель навигации и боковую панель, объявив файлы метаданных `_nav.json` и `_meta.json`. Мы рекомендуем второй подход, поскольку он позволяет сохранить файл конфигурации лаконичным, при этом всё остаётся доступным через `themeConfig`.
  ...
  "json.schemas": [
    {
      ...
      // или "url": "https://unpkg.com/@rspress/core@2.0.0-rc.2/meta-json-schema.json"
    },
    {
      "fileMatch": ["**/_nav.json"],
      "url": "./node_modules/@rspress/core/nav-json-schema.json"
      // или "url": "https://unpkg.com/@rspress/core@2.0.0-rc.2/nav-json-schema.json"
    }
  ]
  // ...
}
