...
When enabled, this option redirects non-canonical URLs to the URL format
selected by [`route.cleanUrls`](#routecleanurls), using the actual matched route
as the source of truth. The page is not reloaded, and the base, locale prefix,
query string, hash, and history state are preserved.
...
| Incoming URL         | Matched route | Client behavior              | Final URL  |
| -------------------- | ------------- | ---------------------------- | ---------- |
| `/file`              | `/file`       | No redirect                  | `/file`    |
| `/file.html`         | `/file`       | `replaceState` to `/file`    | `/file`    |
| `/file/`             | `/file`       | `replaceState` to `/file`    | `/file`    |
| `/file/index`        | `/file`       | `replaceState` to `/file`    | `/file`    |
| `/file/index.html`   | `/file`       | `replaceState` to `/file`    | `/file`    |
| `/folder`            | `/folder/`    | `replaceState` to `/folder/` | `/folder/` |
| `/folder.html`       | `/folder/`    | `replaceState` to `/folder/` | `/folder/` |
| `/folder/`           | `/folder/`    | No redirect                  | `/folder/` |
| `/folder/index`      | `/folder/`    | `replaceState` to `/folder/` | `/folder/` |
| `/folder/index.html` | `/folder/`    | `replaceState` to `/folder/` | `/folder/` |
...
| Incoming URL         | Matched route | Client behavior                        | Final URL            |
| -------------------- | ------------- | -------------------------------------- | -------------------- |
| `/file`              | `/file`       | `replaceState` to `/file.html`         | `/file.html`         |
| `/file.html`         | `/file`       | No redirect                            | `/file.html`         |
| `/file/`             | `/file`       | `replaceState` to `/file.html`         | `/file.html`         |
| `/file/index`        | `/file`       | `replaceState` to `/file.html`         | `/file.html`         |
| `/file/index.html`   | `/file`       | `replaceState` to `/file.html`         | `/file.html`         |
| `/folder`            | `/folder/`    | `replaceState` to `/folder/index.html` | `/folder/index.html` |
| `/folder.html`       | `/folder/`    | `replaceState` to `/folder/index.html` | `/folder/index.html` |
| `/folder/`           | `/folder/`    | `replaceState` to `/folder/index.html` | `/folder/index.html` |
| `/folder/index`      | `/folder/`    | `replaceState` to `/folder/index.html` | `/folder/index.html` |
| `/folder/index.html` | `/folder/`    | No redirect                            | `/folder/index.html` |
...
The server must still serve the requested page variant before this client-side
redirect can run. This behavior follows the canonical URL pattern of
Cloudflare's [HTML handling](https://developers.cloudflare.com/workers/static-assets/routing/advanced/html-handling/).
