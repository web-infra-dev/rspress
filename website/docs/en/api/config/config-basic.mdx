...
| Incoming URL         | Matched route | Client behavior              |
| -------------------- | ------------- | ---------------------------- |
| `/file`              | `/file`       | No redirect                  |
...
| `/folder/index.html` | `/folder/`    | No redirect                            |
