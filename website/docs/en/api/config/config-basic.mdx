...
If a user opens `https://example.com/docs` without the trailing slash and the hosting provider still returns the Rspress homepage, Rspress redirects the browser to `https://example.com/docs/`. Query parameters and hashes are preserved.
