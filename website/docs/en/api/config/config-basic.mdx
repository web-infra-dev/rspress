...
| `/file.html`         | `/file`       | `pushState` to `/file`    | `/file`    |
| `/file/`             | `/file`       | `pushState` to `/file`    | `/file`    |
| `/file/index`        | `/file`       | `pushState` to `/file`    | `/file`    |
| `/file/index.html`   | `/file`       | `pushState` to `/file`    | `/file`    |
| `/folder`            | `/folder/`    | `pushState` to `/folder/` | `/folder/` |
| `/folder.html`       | `/folder/`    | `pushState` to `/folder/` | `/folder/` |
| `/folder/`           | `/folder/`    | No redirect               | `/folder/` |
| `/folder/index`      | `/folder/`    | `pushState` to `/folder/` | `/folder/` |
| `/folder/index.html` | `/folder/`    | `pushState` to `/folder/` | `/folder/` |
...
| Incoming URL         | Matched route | Client behavior                     | Final URL            |
| -------------------- | ------------- | ----------------------------------- | -------------------- |
| `/file`              | `/file`       | `pushState` to `/file.html`         | `/file.html`         |
| `/file.html`         | `/file`       | No redirect                         | `/file.html`         |
| `/file/`             | `/file`       | `pushState` to `/file.html`         | `/file.html`         |
| `/file/index`        | `/file`       | `pushState` to `/file.html`         | `/file.html`         |
| `/file/index.html`   | `/file`       | `pushState` to `/file.html`         | `/file.html`         |
| `/folder`            | `/folder/`    | `pushState` to `/folder/index.html` | `/folder/index.html` |
| `/folder.html`       | `/folder/`    | `pushState` to `/folder/index.html` | `/folder/index.html` |
| `/folder/`           | `/folder/`    | `pushState` to `/folder/index.html` | `/folder/index.html` |
| `/folder/index`      | `/folder/`    | `pushState` to `/folder/index.html` | `/folder/index.html` |
