...
Individual code blocks can override the default using `height` or `fold` meta attributes. See [Code folding](/guide/use-mdx/code-blocks#code-folding) for details.
