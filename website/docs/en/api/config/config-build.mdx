...
To modify the output directory, use [outDir](/api/config/config-basic#outdir).
...
When enabled, Rspress automatically adds link prefixes based on the conventional routes for [i18n](/guide/basic/i18n) and [multi-version docs](/guide/basic/multi-version).
