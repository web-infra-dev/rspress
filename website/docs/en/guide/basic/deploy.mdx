...
1. Install the [zephyr-rspress-plugin](https://www.npmjs.com/package/zephyr-rspress-plugin):

<PackageManagerTabs command="install zephyr-rspress-plugin " />

2. Add the plugin to your `rspress.config.ts`:
...
During the build process, your Rspress documentation site will be automatically deployed and you'll receive a deployment URL. Zephyr Cloud handles asset optimization, global CDN distribution, and provides automatic rollback capabilities for your documentation sites.
