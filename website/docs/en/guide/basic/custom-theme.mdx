...
The [`Layout`](/ui/layout-components/layout) component is designed with a series of slot props specifically for wrapping. You can use these props to extend the default theme layout. Click below to preview the slot locations on this page.
