...
If you are using a Coding Agent, you can install the [rspress-custom-theme](https://github.com/rstackjs/agent-skills#rspress-custom-theme) Agent Skill to help AI better understand the theme customization capabilities mentioned above and provide more accurate suggestions.
