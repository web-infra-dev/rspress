...
## Using AI to customize themes

If you are using a Coding Agent (such as Claude Code, Cursor, etc.), you can install the [rspress-custom-theme](https://github.com/rstackjs/agent-skills#rspress-custom-theme) Agent Skill to help AI better understand the theme customization capabilities mentioned above and provide more accurate suggestions.

For more information about AI-assisted development with Rspress, see the [AI](/guide/start/ai) page.
