...
If you are using a Coding Agent, you can install the [rspress-custom-theme](https://github.com/rstackjs/agent-skills#rspress-custom-theme) Agent Skill to equip AI with full knowledge of Rspress theme customization, enabling it to use CSS variables, Layout slots, component wrapping, or ejection as needed.
