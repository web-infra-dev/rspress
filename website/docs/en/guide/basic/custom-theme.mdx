...
If you are using a Coding Agent, you can install the [rspress-custom-theme](https://github.com/rstackjs/agent-skills#rspress-custom-theme) Agent Skill to empower the Agent to generate a brand new theme for you.
