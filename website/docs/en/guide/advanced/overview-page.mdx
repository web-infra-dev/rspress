---
description: Enable overview page via frontmatter overview configuration, auto-generating grouped content based on _meta.json and article headings.
---
...
If you want to generate a sub-preview page under `theme`, create a new `index.md` in the `theme` directory and configure the frontmatter of `overview: true`.
...
This is a description about theme, including component and utils.
```
