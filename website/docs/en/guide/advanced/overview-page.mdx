...
Use a [custom theme](/guide/basic/custom-theme) to modify the styles of the [OverviewGroup](/ui/layout-components/overview-group) component, while continuing to use the built-in Overview page functionality:
...
Use the [OverviewGroup](/ui/layout-components/overview-group) component with `pageType: doc-wide` to adjust the page layout and define content yourself:
