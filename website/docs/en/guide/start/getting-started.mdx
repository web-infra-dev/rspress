---
description: Quickly create an Rspress project via the scaffold or manual setup, configure Git initialization, and learn the basic development, build, and preview workflows.
---
...
```bash
npx -y create-rspress@latest my-docs --template basic-theme --no-git
```
...
- Read [Basic features](/guide/basic/conventional-route) to learn routing, homepages, static assets, deployment, and other common documentation site features.
