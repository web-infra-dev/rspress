...
After running the command, the CLI guides you through the project name, theme customization, and additional tools such as ESLint, Rslint, Biome, or Prettier.
