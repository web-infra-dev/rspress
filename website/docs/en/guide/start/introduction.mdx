---
description: Rspress is a high-performance static site generator based on Rsbuild, featuring millisecond-level startup, AI-friendly SSG-MD, MDX support, full-text search, i18n and multi-version docs.
---
