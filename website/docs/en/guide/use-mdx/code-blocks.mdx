...
When a code block is long, you can use the `toggle` attribute to enable expand/collapse functionality. The code block will be collapsed to a specified height with an expand button at the bottom. Click to expand and view the full code.
...
```jsx title="toggle-demo.tsx" toggle height="350"
