...
The `HomeHero` component automatically reads the `hero` configuration from frontmatter. For detailed configuration options of `hero`, please refer to [Frontmatter Config](/api/config/config-frontmatter#hero).
