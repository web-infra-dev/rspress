...
You can configure `features` in the frontmatter of your mdx file, and the component will automatically read it. For detailed configuration options of `features`, please refer to [Frontmatter Config](/api/config/config-frontmatter#features).
