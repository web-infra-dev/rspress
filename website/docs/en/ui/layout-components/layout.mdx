...
Click below to insert labeled examples into the actual slots on this page. While previewing, visit the homepage to see the Hero and Features slots, and use the floating control to exit at any time. On narrow screens, open the sidebar or outline menu to see their slots.
