...
Click below to show the actual slot locations on this page. Existing slot content is highlighted with a translucent overlay; empty slots display labeled examples. While previewing, visit the homepage to see the Hero and Features slots, and use the floating control to exit at any time. On narrow screens, open the sidebar or outline menu to see their slots.
