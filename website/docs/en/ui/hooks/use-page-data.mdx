---
description: usePageData hook (deprecated) for accessing current page metadata, use usePage instead.
tag: deprecated
---
...
> Capabilities have been split into [`usePage`](./use-page), [`usePages`](./use-pages), and [`useSite`](./use-site); prefer these dedicated hooks as needed.
