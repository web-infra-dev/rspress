...
The [llms.txt specification](https://llmstxt.org/) defines a Markdown index file placed at the root or a subpath of a website. It contains an introduction to the website and detailed content.
