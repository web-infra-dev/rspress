...
date: 2026-01-30
authors: ['sooniter']
description: 'Rspress 2.0 is released. Brand new theme, built-in SSG-MD and llms.txt generation, Shiki integrated by default, lazyCompilation and persistent cache enabled by default, documentation DX improvements including dead link checking and file code blocks. Additionally, Rspress can now be selected as the documentation tool when creating Rslib projects.'
sidebar: false
pageType: doc-wide
---
