...
date: 2026-01-30
authors: ['sooniter']
description: 'Rspress 2.0 is officially released, featuring a brand new theme, AI-native SSG-MD and llms.txt generation, Shiki code highlighting, lazyCompilation, an improved documentation development experience, and Rslib template support for Rspress.'
sidebar: false
pageType: doc-wide
---
...
Building on this foundation, based on community feedback and suggestions, we aim to make further progress in [**theme aesthetics**](#brand-new-theme), [**AI-native**](#llms-txt-ssg-md), [**documentation development experience**](#doc-dx), [**integration with Rslib**](#rslib-rspress), and more.
