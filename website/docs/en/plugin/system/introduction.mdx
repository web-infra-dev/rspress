...
- Insert some [**custom logic**](/plugin/system/plugin-api#beforebuildafterbuild) before and after the build process. Such as closing some event listeners after the build process ends.
