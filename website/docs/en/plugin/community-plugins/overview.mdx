...
- [rspress-plugin-third-parties](https://github.com/sanjaiyan-dev/rspress-plugin-third-parties): High-performance, zero-config plugin for loading third-party scripts and embeds (Google Analytics, GTM, YouTube, Google Maps) with maximum Core Web Vitals efficiency. Features build-time React Compiler auto-memoization and non-blocking lazy loading. Explore the [Official Docs & Live Demos](https://sanjaiyan-dev.github.io/rspress-plugin-third-parties/).
