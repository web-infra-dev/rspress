...
This plugin is only intended as a fallback solution for scenarios where `ssg: false` is used. It is recommended to prioritize using the [SSG-MD](/guide/basic/ssg-md) feature.
