...
Instead of writing component code directly in an MDX code block, you can use it with [File Code Block](../../guide/use-mdx/code-blocks.mdx#file-code-block) and keep example code in separate files.
