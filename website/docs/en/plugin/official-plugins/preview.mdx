...
Using iframe preview mode isolates the runtime environment between your documentation and components, effectively preventing style conflicts and other issues.
...
- ` ```tsx preview`: Render as a previewable component
