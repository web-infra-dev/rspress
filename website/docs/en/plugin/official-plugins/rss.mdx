...
If an array of strings is provided, they will be treated as glob patterns. RSS generation will be excluded for pages whose route path matches any of the patterns.
