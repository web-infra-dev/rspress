...
Rspress 是基于 [Rsbuild](https://rsbuild.rs/) 的静态站点生成器，面向开发者提供文档站搭建能力。自 2023 年正式发布以来，Rspress 已走过三年。截至 1.47.0 版本，Rspress 累计迭代 **144 个版本**，共有 **125 位贡献者** 参与。越来越多的开发者选择 Rspress，借助其**极致的编译性能、约定式路由和组件库预览**等功能，搭建美观可靠的文档站点。

在此基础上，根据社区的反馈和建议，我们希望在 [**主题美观度**](#brand-new-theme)、 [**AI-native**](#llms-txt-ssg-md)、[**文档开发体验**](#doc-dx)、[**与 Rslib 连用**](#rslib-rspress) 等各方面更进一步。
...
模版中内置了 [rsbuild-plugin-workspace-dev](https://github.com/rstackjs/rsbuild-plugin-workspace-dev) 插件，实现了在 Rspress 开发服务器启动的同时启动 Rslib 的 watch 开发命令。
