...
- [rspress-plugin-live2d](https://github.com/rstackjs/rspress-plugins/tree/main/packages/rspress-plugin-live2d): 为你的 Rspress 站点添加看板娘，基于 [oh-my-live2d](https://oml2d.hacxy.cn/).
...
- [rspress-plugin-auto-meta](https://github.com/smileluck/rspress-plugin-auto-meta.git): 自动为您的文档生成导航元数据的 Rspress 插件。
- [rspress-plugin-map](https://github.com/buyfakett/rspress-plugin-map.git): 在 rspress 中插入交互式地图，灵感来自于 [hexo-tag-map](https://github.com/kuole-o/hexo-tag-map.git)。
...
- [rspress-plugin-viz](https://github.com/elecmonkey/rspress-plugin-viz): 为 Rspress 提供基于 [@viz-js/viz](https://github.com/mdaines/viz-js/) 的 Graphviz 图表渲染支持。
- [rspress-plugin-third-parties](https://github.com/sanjaiyan-dev/rspress-plugin-third-parties): 高性能、零配置的第三方脚本与嵌入内容加载插件，支持 Google Analytics、GTM、YouTube、Google Maps 和 Twitter/X，并针对 Core Web Vitals 进行优化。提供构建时 React Compiler 自动记忆化和非阻塞懒加载能力。查看[官方文档与在线演示](https://sanjaiyan-dev.github.io/rspress-plugin-third-parties/)。

## 贡献社区插件

欢迎社区贡献 Rspress 插件！插件 npm 包名约定以 `rspress-plugin-` 开头。

你可以选择以下方式贡献：

- 在自己的仓库中开发并发布插件，然后提交 PR 将插件添加到本页面的社区插件列表中。
- 直接向 [rspress-plugins](https://github.com/rstackjs/rspress-plugins) 仓库贡献，该仓库中已有多个社区插件，可以作为参考。
