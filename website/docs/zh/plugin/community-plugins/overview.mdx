...
- [rspress-plugin-third-parties](https://github.com/sanjaiyan-dev/rspress-plugin-third-parties): 高性能、零配置的第三方脚本与嵌入内容加载插件，支持 Google Analytics、GTM、YouTube 和 Google Maps，并针对 Core Web Vitals 进行优化。提供构建时 React Compiler 自动记忆化和非阻塞懒加载能力。查看[官方文档与在线演示](https://sanjaiyan-dev.github.io/rspress-plugin-third-parties/)。
