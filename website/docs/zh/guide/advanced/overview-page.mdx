...
通过[自定义主题](/guide/basic/custom-theme)来修改 [OverviewGroup](/ui/layout-components/overview-group) 组件的样式，同时继续使用 Overview 页的内置功能：
...
使用 [OverviewGroup](/ui/layout-components/overview-group) 组件并通过 `pageType: doc-wide` 调整页面布局，自行定义页面内容：
