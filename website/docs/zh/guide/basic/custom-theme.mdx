...
如果你正在使用 Coding Agent（如 Claude Code、Cursor 等），可以安装 [rspress-custom-theme](https://github.com/rstackjs/agent-skills#rspress-custom-theme) Agent Skill，帮助 AI 更好地理解上述主题定制能力，提供更准确的建议。
