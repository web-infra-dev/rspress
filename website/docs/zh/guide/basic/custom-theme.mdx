...
如果你正在使用 Coding Agent，可以安装 [rspress-custom-theme](https://github.com/rstackjs/agent-skills#rspress-custom-theme) Agent Skill，让 AI 掌握 Rspress 主题定制的完整知识，按需使用 CSS 变量、Layout 插槽、组件 wrap 或 eject 等方式完成定制。

更多关于 AI 辅助开发 Rspress 的信息，请参阅 [AI](/guide/start/ai) 页面。
