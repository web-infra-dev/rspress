...
| -------------------- | ---------- | ------------------------- | ---------- |
| `/file`              | `/file`    | 不重定向                  | `/file`    |
| `/file.html`         | `/file`    | `pushState` 到 `/file`    | `/file`    |
| `/file/`             | `/file`    | `pushState` 到 `/file`    | `/file`    |
| `/file/index`        | `/file`    | `pushState` 到 `/file`    | `/file`    |
| `/file/index.html`   | `/file`    | `pushState` 到 `/file`    | `/file`    |
| `/folder`            | `/folder/` | `pushState` 到 `/folder/` | `/folder/` |
| `/folder.html`       | `/folder/` | `pushState` 到 `/folder/` | `/folder/` |
| `/folder/`           | `/folder/` | 不重定向                  | `/folder/` |
| `/folder/index`      | `/folder/` | `pushState` 到 `/folder/` | `/folder/` |
| `/folder/index.html` | `/folder/` | `pushState` 到 `/folder/` | `/folder/` |
...
| 传入 URL             | 匹配路由   | 客户端行为                          | 最终 URL             |
| -------------------- | ---------- | ----------------------------------- | -------------------- |
| `/file`              | `/file`    | `pushState` 到 `/file.html`         | `/file.html`         |
| `/file.html`         | `/file`    | 不重定向                            | `/file.html`         |
| `/file/`             | `/file`    | `pushState` 到 `/file.html`         | `/file.html`         |
| `/file/index`        | `/file`    | `pushState` 到 `/file.html`         | `/file.html`         |
| `/file/index.html`   | `/file`    | `pushState` 到 `/file.html`         | `/file.html`         |
| `/folder`            | `/folder/` | `pushState` 到 `/folder/index.html` | `/folder/index.html` |
| `/folder.html`       | `/folder/` | `pushState` 到 `/folder/index.html` | `/folder/index.html` |
| `/folder/`           | `/folder/` | `pushState` 到 `/folder/index.html` | `/folder/index.html` |
| `/folder/index`      | `/folder/` | `pushState` 到 `/folder/index.html` | `/folder/index.html` |
