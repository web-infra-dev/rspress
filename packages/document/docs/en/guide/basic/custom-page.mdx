...
Read more details on how to customize **open graph images (og:image)** and **open graph title (og:title)** can be seen here in [frontmatter config](https://rspress.dev/api/config/config-frontmatter#head).
