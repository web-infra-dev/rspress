...
Rspress supports two types of links: **file path format** and **URL format**. They render exactly the same results, differing only in code style.
...
-[Rspack Document](https://rspack.rs/)

-[Rsbuild Document](https://rsbuild.rs/)
...
Configure the invalid links automatically by using the [markdown.link.checkDeadLinks](/api/config/config-build#markdownlinkcheckdeadlinks) configuration.
