...
For this plugin to work correctly, you need to set the fallback related configuration to the `404.html` page in the build artifacts in the relevant deployment configuration.
