...
:::tip TIP
In order to get better type hints, you can install `@rspress/shared` in the project, and then import the `RspressPlugin` type through `import type { RspressPlugin } from '@rspress/shared'`.
:::
