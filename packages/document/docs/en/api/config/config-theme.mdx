  ...
  themeConfig: {
    socialLinks: [
      ...
      },
      {
        icon: 'github',
        mode: 'dom',
        content: <img src="https://lf3-static.bytednsdoc.com/obj/eden-cn/rjhwzy/ljhwZthlaukjlkulzlp/rspress/rspress-navbar-logo-0904.png" alt="logo" id="logo" class="mr-4 rspress-logo dark:hidden">,
      },
    ],
  },
});
...
- When in the `dom` mode, you can pass ReactNode content to render directly into the content field.
