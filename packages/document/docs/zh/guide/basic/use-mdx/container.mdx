...
:::tip
Rspress 提供了两种风格的语法，[`:::` 语法](#three-colon-syntax) 和 [GitHub Markdown Alerts](#github-markdown-alerts-syntax) 语法。
:::
...
我们更推荐直接使用 `:::tip 自定义标题` 这种语法。

在 `.mdx` 文件中使用 `:::` 语法且使用大括号语法自定义标题时，需注意转义。
